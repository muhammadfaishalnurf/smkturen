                            ...
                            <table class="table w-100 dataTable no-footer dtr-inline collapsed" aria-describedby="table_vendor_info">
                                ...
                                <tbody class="alldata">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/database/update/{{$item->id}}" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#exampleModal-{{ $item->id }}"><i class="bi bi-pencil-square"></i></a>
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="judul" required="required" value="{{$per->judul}}">
                        </div>
                        <div class="form-grup">
                            <label class="form-label">Jml_Buku</label>
                            <input type="number" class="form-control" name="jml_buku" required="required" value="{{$per->jml_buku}}">
                        </div>
                        <div class="form-group">
                            <label class="form-label">Kode_Buku</label>
                            <input type="text" class="form-control" name="kode_buku" required="required" value="{{$per->kode_buku}}">
                        </div>
                    </form>
                </div>
